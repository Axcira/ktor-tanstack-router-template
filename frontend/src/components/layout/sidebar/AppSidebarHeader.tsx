...
export default function AppSidebarHeader() {
  ...
  return (<SidebarHeader
      className="p-4 h-17 border-b border-sidebar-border flex flex-row items-center justify-between group-data-[state=collapsed]:p-2 group-data-[state=collapsed]:justify-center">
